   ...
   <?php echo $welcome; ?>
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="col-xl-6 col-md-6">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Pending Lost Pets Posts</div>         
       ...
       if ($result) {
         ...
         echo "Error in query execution";
                    ...
                    ?></p>
                                        <a class="small text-white stretched-link" href="pendinglost.php"></a>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Pending Found Pets Posts</div>         
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                    <p><?php 
                   $sql = "SELECT 
       ...
       if ($result) {
         ...
         echo "Error in query execution";
                    ...
                    ?></p>
                                        <a class="small text-white stretched-link" href="pendingfound.php"></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid px-4">
                            ...
                            <h2 class='text-center mb-5 mt-5'>All Pending Post </h2>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['approve'])) {
        $id = $_POST['id'];
        $updateSql = "UPDATE reportlostpet SET approved = 1 WHERE id = $id";
        $db->query($updateSql);
  ...
  Post approved!
        ...
        $id = $_POST['id'];
        $deleteSql = "DELETE FROM reportlostpet WHERE id = $id";
        $db->query($deleteSql);
        echo "<div class='alert alert-success'  role='alert'>
        Post Deleted!
      </div>";
...
$sql = "SELECT r.id, r.pet, r.registered, r.petname, r.fur, r.breed, r.petimage, r.lastfound, r.approved, r.date, r.expirationdate, r.userid, r.petimage, r.contactname, r.contactnumber, r.contactemail, u.firstname, u.lastname 
FROM reportlostpet r 
            ...
            <div class="col-md-3 mb-4">
                ...
                <img src="../<?php echo $row['petimage']; ?>" class="card-img-top col-md-2 fixed-image" alt="Pet Image">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Last Seen:</strong> <?php echo $row['lastfound']; ?></p>
                        <p class="card-text"><strong>Date Posted:</strong> <?php echo $row['date']; ?></p>
                        <p class="card-text"><strong>Contact Name:</strong> <?php echo $row['contactname']; ?></p>
                        <p class="card-text"><strong>Contact Number:</strong> <?php echo $row['contactnumber']; ?></p>
                        <p class="card-text"><strong>Contact Email:</strong> <?php echo $row['contactemail']; ?></p>
