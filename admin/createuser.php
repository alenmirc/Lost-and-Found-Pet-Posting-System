                ...
                <main>
                    <div class="container-fluid px-4">
                       ...
                       if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $sql = "INSERT INTO users (firstname, lastname, email, phonenumber, address, password, verification_code, is_verified) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                        
                        $stmt = $db->prepare($sql);
                        $stmt->bind_param('sssssssi', $firstname, $lastname, $email, $phonenumber, $address, $password, $verification_code, $is_verified);
