...
<html lang="en">
   ...
   <?php echo $welcome; ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lost Pet</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lost Pets</li>
                        </ol>
                ...
                ?>
                        ...
                        <a href="createlost.php"><button type='button' class='btn btn-primary mb-2'>Create New</button></h1></a>
    ...
    $sql = "SELECT id, registered, userid, petname, pet,  breed, fur, petimage, lastfound, contactname, contactnumber, contactemail, approved, date, expirationdate FROM reportlostpet";
    $result = $db->query($sql);
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>
            <a href='editlost.php?id=" . $row["id"] . "' class='btn btn-primary'>Edit</a>
