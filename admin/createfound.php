...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Create a new record in the "reportfoundpet" table
    // Modify the SQL query according to your table structure
    $sql = "INSERT INTO reportfoundpet (registered, userid, petid, petname, pet, fur, breed, petimage, placefound, foundername, foundercontact, founderemail, surrender, authorityname, authoritycontact, authorityaddress, approved, date, expirationdate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?)";
    
    $stmt = $db->prepare($sql);
    $stmt->bind_param('iissssssssssisssis', $registered, $userid, $petid, $petname, $pet, $fur, $breed, $petimage, $placefound, $foundername, $foundercontact, $founderemail, $surrender, $authorityname, $authoritycontact, $authorityaddress, $approved, $expirationdate);
...
?>
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="petid" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="placefound" required>
            </div>
            
            <div class="mb-3">
                <label for="foundername" class="form-label">Founder's Name:</label>
                <input type="text" class="form-control" name="foundername" required>
            </div>
            
            <div class="mb-3">
                <label for="foundercontact" class="form-label">Founder's Contact Number:</label>
                <input type="text" class="form-control" name="foundercontact" required>
            </div>
            
            <div class="mb-3">
                <label for="founderemail" class="form-label">Founder's Email:</label>
                <input type="email" class="form-control" name="founderemail" required>
            </div>
            
            <div class="mb-3">
                <label for="surrender" class="form-label">Surrender:</label>
                <input type="text" class="form-control" name="surrender" required>
            </div>
            
            <div class="mb-3">
                <label for="authorityname" class="form-label">Authority's Name:</label>
                <input type="text" class="form-control" name="authorityname" required>
            </div>
            
            <div class="mb-3">
                <label for="authoritycontact" class="form-label">Authority's Contact Number:</label>
                <input type="text" class="form-control" name="authoritycontact" required>
            </div>
            
            <div class="mb-3">
                <label for="authorityaddress" class="form-label">Authority's Address:</label>
                <input type="text" class="form-control" name="authorityaddress" required>
            </div>
            ...
            <button type="submit" class="btn btn-primary">Report Found Pet</button>
        </form>
    </div>
