...
<html lang="en">
    <head>
        ...
        <title>Pending Lost Posts</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                            ...
                            <h2 class='text-center mb-5 mt-5'>Pending Lost Pets Post </h2>
            ...
            <div class="col-md-3 mb-4">
                ...
                <img src="../<?php echo $row['petimage']; ?>" class="card-img-top col-md-2 fixed-image" alt="Pet Image">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Last Found:</strong> <?php echo $row['lastfound']; ?></p>
