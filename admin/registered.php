   ...
   <?php echo $welcome; ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registered Pets</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registered Pets</li>
                        </ol>
                ...
                ?>
                        ...
                        <a href="createregister.php"><button type='button' class='btn btn-primary mb-2'>Create New</button></h1></a>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>
            <a href='editregister.php?id=" . $row["id"] . "' class='btn btn-primary'>Edit</a>
