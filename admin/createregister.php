...
<html lang="en">
    <head>
        ...
        <title>Create Register Pets</title>
   ...
   <?php echo $welcome; ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                   ...
                   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    // Create a new record in the "registerpet" table
                    // Modify the SQL query according to your table structure
                    $sql = "INSERT INTO registerpet (petid, userid, petname, pet, breed, fur, petimage, ownersname, contactnumber, address, email, notes, qr, date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
                    
                    $stmt = $db->prepare($sql);
                    $stmt->bind_param('ssiisssssssss', $petid, $userid, $petname, $pet, $breed, $fur, $petimage, $ownersname, $contactnumber, $address, $email, $notes, $qr);
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="ownersname" required>
            </div>
