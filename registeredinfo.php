...
$sql = "SELECT id, petid, userid, petname, pet, breed, fur, petimage, ownersname, contactnumber, address, email, notes, qr, date FROM registerpet WHERE petid='$viewid'";
$result = $db->query($sql);
while($row = $result->fetch_assoc()) {
  if ($row['petid'] === $viewid && $row['userid'] !== $users['id']) {
