          ...
          <div class="row no-gutters">
            <div class="col-md-7">
              <div class="contact-wrap w-100 p-md-5 p-4">
                ...
                <form method="POST" action="confirmregister.php" enctype="multipart/form-data">
                  <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label class="label" for="ownersname">Owner's Name</label>
                        <input type="text" class="form-control" value="<?php echo $users['firstname']; ?> <?php echo $users['lastname']; ?>" name="ownersname" id="ownersname" placeholder="Owner's Name" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="address" class="form-control" id="address" cols="30" rows="4" value="<?php echo $users['address']; ?>" placeholder="Address" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="label" for="email">Email (optional)</label>
                        <input type="text" class="form-control" name="email" value="<?php echo $users['email']; ?>" id="email" placeholder="Email">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="label" for="notes">Notes</label>
                        <textarea name="notes" class="form-control" id="notes" cols="30" rows="4" placeholder="Notes"></textarea>
                      </div>
                    </div>
