...
?>
    ...
    <!-- END nav -->
    <div class="hero-wrap js-fullheight" style="background-image: url('images/front.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
          	<h1 class="mb-4">Bridging the Gap,<br>Reuniting Paws </h1>
            <p><a href="login.php" class="btn btn-primary mr-md-4 py-3 px-4">Get Started <span class="ion-ios-arrow-forward"></span></a></p>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
			  ...
			  <span><img  src="images/lostapet.png"></img></span>
              </div>
              <div class="media-body">
                <h3 class="heading">Lost Pets</h3>
                <p>Browse through listings of lost pets, viewing detailed descriptions and information about each animal. Ensuring that owners have the best possible chance of finding their missing companions.</p>
                <a href="lostpets.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              <div class="icon d-flex align-items-center justify-content-center">
			  <span><img  src="images/foundapet.png"></img></span>
              </div>
              <div class="media-body">
                <h3 class="heading">Found Pets</h3>
                <p>Browse through a wide range of listings of found pets. Each listing contains detailed descriptions and relevant information about the found animal, such as their species, breed, and distinctive features.</p>
                <a href="foundpets.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              <div class="icon d-flex align-items-center justify-content-center">
			  <span><img  src="images/registerapet.png"></img></span>
              </div>
              <div class="media-body">
                <h3 class="heading">Register Pet</h3>
                <p> Easily input essential details about their pets. LFPRS generates a unique QR code specific to the registered pet. This QR code can be easily printed and attached to the pet's collar or tag.</p>
                <a href="registerpet.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>      
          </div>
        </div>
    ...
    <section class="ftco-counter" id="section-counter">
    	<div class="container">
            <div class="block-18 text-center">
              <div class="text">
                <strong><span>We help lost pets find their way back home and assist in reuniting families with their beloved companions.</span></strong>
              </div>
              <div class="text">
              	<span>Enter a photo of your missing pet and serach our lost and found pet database to find them.</span>
              </div>
            </div>
          </div>
