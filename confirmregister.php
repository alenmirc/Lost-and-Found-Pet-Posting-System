...
?>
 ...
 <div class="col-md-12">
 <label class="label">Pet Name: </strong><?php echo $petname;?></label>
        <br>
</div>
<div class="col-md-12">
...
<label class="label">Owners Name: </strong><?php echo $ownersname;?></label>
        <br>
</div> <div class="col-md-12">
<label class="label">Contact Number: </strong><?php echo $contactnumber;?></label>
        <br>
</div> <div class="col-md-12">
<label class="label">Address: </strong><?php echo $address;?></label>
        <br>
</div> <div class="col-md-12">
<label class="label">Email: </strong><?php echo $email;?></label>
        <br>
</div> <div class="col-md-12">
<label class="label">Notes: </strong><?php echo $notes;?></label>
        <br>
</div>
<br><br><br>
<div class="col-md-12">
                      <div class="form-group">
                        <strong><label class="label" for="photo">Please Upload the Photo of pet</label>  </strong>
        ...
        <input type='hidden' name='petname' value='<?php echo $petname;?>'>
          ...
          <input type='hidden' name='ownersname' value='<?php echo $ownersname;?>'>
          ...
          <input type='hidden' name='notes' value='<?php echo $notes;?>'>
                ...
                <a href="registerpet.php"><button type='submit' name='cancel' class='btn btn-danger'>Cancel</button></a>
              </div>
            </div>
