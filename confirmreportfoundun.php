...
<div class="col-md-12">
        <label class="label">Pet: </strong><?php echo $pet; ?></label>
        <br>
</div> <div class="col-md-12">
<label class="label">Breed: </strong><?php echo $breed; ?></label>
        <br>
</div> <div class="col-md-12">
<label class="label">Fur: </strong><?php echo $fur; ?></label>
</div> <div class="col-md-12">
...
<div class="col-md-12">
         ...
         I hereby agree that my contact information will be disclosed to LFPRS Users.
          ...
          <input type='hidden' name='fur' value='<?php echo $fur?>'>
          ...
          <input type='hidden' name='foundername' value=''>
          <input type='hidden' name='founderemail' value=''>
          <input type='hidden' name='foundercontact' value=''>
