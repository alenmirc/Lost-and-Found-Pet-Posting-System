          ...
          <div class="row no-gutters">
            <div class="col-md-7">
              <div class="contact-wrap w-100 p-md-5 p-4">
                ...
                <form method="POST" action="confirmreportfoundun.php" enctype="multipart/form-data">
                  <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="label" for="fur">Place Found</label>
                        <input type="text" class="form-control" name="placefound" id="fur" placeholder="Last Seen" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                    <P class="mt-3">Contact Information</P>
                    <label for="additionalInfo" style="color:red";>It is advisable and required to surrender an unregistered pet to the authorities in order to avoid any potential issues.</label>
