...
$sql = "SELECT id, pet, registered, petname, fur,  breed, petimage, lastfound, date, expirationdate FROM reportlostpet WHERE id=$viewid";
$result = $db->query($sql);
    ...
    <div class="container bootstrap snippets bootdey">
        <div class="container">
            ...
            echo "<span class='badge badge-pill badge-danger'>Expired</span>";
                                            ...
                                            <p class="font-weight-bold font-size-sm">If you think you've seen me, kindly click I'VE SEEN THIS PET button to positively identify and help me.
                                            <a href='lostinfo.php?id=<?php echo $row['id'] ?>'><button class="btn btn-success mt-3">I've seen this pet 
                  </button></a>
