...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE users SET firstname='$first_name', lastname='$last_name', phonenumber='$phone', address='$address' WHERE id=$userid";
                ...
                <form action="#" method="POST">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="first-name" value="<?php echo $row['firstname'] ?>" name="first_name" class="form-control" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="last-name">Last Name</label>
                            <input type="text" id="last-name" value="<?php echo $row['lastname'] ?>" name="last_name" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" id="disabledInput" value="<?php echo $row['email'] ?>" name="email" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="tel" id="phone" name="phone" value="<?php echo $row['phonenumber'] ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
