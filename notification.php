...
$userid = $users['id'];
$sql = "SELECT id, petimage, contactname, contactnumber, message, date FROM notifylost WHERE userid=$userid ORDER BY id DESC";
...
while($row = $result2->fetch_assoc()) {
  ...
  $datePosted = new DateTime($row['date']);
        $interval = date_diff($datePosted, $currentDateTime);
...
<img src="<?php echo $row['petimage'] ?>" class="mr-3" alt="Image" style="width: 150px; height: 150px; object-fit: cover;">
</div>
<div class="col-md-9">
<div class="d-flex align-items-center">
<div>
<p class="mb-1" style="color: #333; font-weight: bold;">Someone saw your pet!</p>
<small style="color: #777;"><?php echo $timeAgo; ?></small><br>
<small style="color: #777;">From: <?php echo $row['contactname'] ?></small><br>
<small style="color: #777;">Contact Number: <?php echo $row['contactnumber'] ?></small><br>
<small style="color: #777;">Message: <?php echo $row['message'] ?></small>
</div>
</div>
<div class="d-flex mt-2">
<a href="deleteaction/deletenotify.php?id=<?php echo $row['id'] ?>" class="btn btn-danger  mr-2" onclick="return confirm('Are you sure you want to remove this?');">Delete</a>
</div>
</div>
</div>
</div>
