                ...
                <form method="POST" action="confirmregister.php" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <label for="selectPet">Do you see qr code at the collar's pet? (means pet is LFPRS registered)</label>
<select class="form-control" name="pet" id="selectPet" required onchange="handleChange(this.value)">
...
<script>
    function handleChange(value) {
        if (value === "yes") {
            window.location.href = "reportfoundregistered.php";
        } else if (value === "no") {
            window.location.href = "reportfoundunregistered.php";
        }
    }
</script>
